...
using MieMieFrameWork.Editor.MmAssets;
...
namespace MieMieFrameWork.Editor.EventBusForEditor
{
    ...
    {
        private const string DefaultOutputPath = MmEditorPaths.EventConstKeyAsset;
        ...
        [MenuItem("Tools/MieMieFrameWork/Event Center")]
        ...
        private void OnGUI()
        {
            ...
            if (!EventBusLibraryChecker.DrawInstallGate())
                return;
        ...
        private void DrawRuntimeMonitorTab()
        {
            ...
            EditorGUILayout.LabelField($"最近触发: {EventCenter.LastTriggeredKey}  时间: {EventCenter.LastTriggeredTime:F2}s");
            EditorGUILayout.Space(4);
