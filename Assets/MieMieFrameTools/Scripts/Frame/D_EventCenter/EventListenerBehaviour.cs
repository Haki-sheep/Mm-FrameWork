namespace MieMieFrameWork
{
    ...
    public abstract class EventListenerBehaviour : MonoBehaviour
    {
        ...
        /// </summary>
        protected virtual EventBus<E_EventConstKey> Bus => null;
        ...
        /// 监听无参数事件
        /// </summary>
        protected void Listen(EventBus<E_EventConstKey> bus, E_EventConstKey eventKey, Action action)
        {
        ...
        /// 监听单参数事件
        /// </summary>
        protected void Listen<T>(EventBus<E_EventConstKey> bus, E_EventConstKey eventKey, Action<T> action)
        {
            bus.AddEventListener(eventKey, action);
            unregisterActionList.Add(() => bus.RemoveListener(eventKey, action));
        }
        ...
        /// 监听双参数事件
        /// </summary>
        protected void Listen<T0, T1>(EventBus<E_EventConstKey> bus, E_EventConstKey eventKey, Action<T0, T1> action)
        {
            bus.AddEventListener(eventKey, action);
            unregisterActionList.Add(() => bus.RemoveListener(eventKey, action));
        }
        ...
        /// 监听三参数事件
        /// </summary>
        protected void Listen<T0, T1, T2>(EventBus<E_EventConstKey> bus, E_EventConstKey eventKey, Action<T0, T1, T2> action)
        {
            bus.AddEventListener(eventKey, action);
            unregisterActionList.Add(() => bus.RemoveListener(eventKey, action));
        }
        ...
        /// 监听四参数事件
        /// </summary>
        protected void Listen<T0, T1, T2, T3>(EventBus<E_EventConstKey> bus, E_EventConstKey eventKey, Action<T0, T1, T2, T3> action)
        {
            bus.AddEventListener(eventKey, action);
            unregisterActionList.Add(() => bus.RemoveListener(eventKey, action));
        }
        ...
        /// 监听五参数事件
        /// </summary>
        protected void Listen<T0, T1, T2, T3, T4>(EventBus<E_EventConstKey> bus, E_EventConstKey eventKey, Action<T0, T1, T2, T3, T4> action)
        {
            bus.AddEventListener(eventKey, action);
            unregisterActionList.Add(() => bus.RemoveListener(eventKey, action));
        }
